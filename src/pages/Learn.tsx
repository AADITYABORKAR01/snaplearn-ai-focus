...
const SAMPLE_COURSES = {
  "001": {
    ...
    videoId: "dQw4w9WgXcQ",
    // This is a placeholder - YouTube video ID
    sections: [{
      title: "Introduction",
      lessons: [{
        id: "001-1",
      ...
      <main className="flex-1 flex flex-col md:flex-row">
        ...
        <div className={`flex-1 p-4 ${showSidebar ? 'md:mr-[300px]' : ''}`}>
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mb-6">
              <VideoPlayer videoId={course.videoId} title={course.title} onTimeUpdate={handleTimeUpdate} />
            </div>
            
            <div className="mt-8">
              <NoteEditor videoId={course.videoId} initialNotes={notes} currentTime={currentVideoTime} onSave={handleSaveNotes} />
            </div>
        ...
        <div className={`
          ...
          <div className="p-4 border-b flex justify-between items-center">
            <h2 className="font-semibold">Course Content Snaps</h2>
